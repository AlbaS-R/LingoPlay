...
// El tipo de la imagen es StaticImageData
        ...
        <section className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-4 sm:grid-cols-2">
          {languages.map((language) => (
            <Link
              key={language.name}
              href="/learn"
              className="flex cursor-pointer flex-col items-center gap-4 rounded-2xl border-2 border-b-4 border-gray-400 px-6 py-6 text-lg font-bold hover:bg-gray-300 hover:bg-opacity-20"
